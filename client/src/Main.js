            ...
            return (           
                ...
                <div className="col-lg-6 mt-2">
                    ...
                    <table className="table">
                        ...
                        <tbody id="regionesList">
                            { this.props.documentosPorCliente.map((documento, key) => {
                                if(documento.id > 0)
                                {
                                    return(
                                    ...
                                    return(
                                        <tr>
                                            <td colspan="5">No registra Documentos</td>
                                        </tr>
                                    )
                                }
                ...
                <MantenedorNotaria documentos = {this.props.documentos}/>
            </div>   
